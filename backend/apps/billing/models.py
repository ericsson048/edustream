...
class SubscriptionPlan(models.Model):
    ...
    features = models.JSONField(default=list, blank=True, help_text="List of feature strings to display")
    badge = models.CharField(max_length=120, blank=True, default="", help_text="e.g. 'Most Popular'")
